    ...
    if (loading) {
        return (
            <div className="h-[60vh] flex flex-col items-center justify-center">
                ...
                <p className="text-slate-500 dark:text-slate-400 font-medium">Loading system configurations...</p>
            </div>
        );
    }
    ...
    return (
        <div className="max-w-4xl mx-auto space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-2 tracking-tight">System Configuration</h1>
                    <p className="text-slate-500 dark:text-slate-400">Manage office hours, late thresholds, and global policy.</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={saving}
                    className="bg-primary-600 hover:bg-primary-500 disabled:bg-slate-100 dark:bg-slate-800 disabled:text-slate-600 text-slate-900 dark:text-white px-8 py-3 rounded-2xl font-bold text-sm transition-all flex items-center gap-2 active:scale-95 shadow-lg shadow-primary-900/40"
                >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-white dark:bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 p-8 rounded-[2rem] space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="p-2.5 rounded-xl bg-primary-600/10 border border-primary-500/20 text-primary-500">
                            <Clock size={20} />
                        </div>
                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">Desk App Policy</h2>
                    </div>

                    <div className="space-y-4">
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Office Start Time</label>
                            <input
                                type="time"
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                        ...
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Late Threshold (Mins)</label>
                            <input
                                type="number"
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                        ...
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Required Hours</label>
                            <input
                                type="number"
                                step="0.5"
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                ...
                <div className="bg-white dark:bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 p-8 rounded-[2rem] space-y-6">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">Field App Policy</h2>
                    </div>

                    <div className="space-y-4">
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Daily Start Time</label>
                            <input
                                type="time"
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                        ...
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Goal Working Hours</label>
                            <input
                                type="number"
                                step="0.5"
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Visits Goal</label>
                                <input
                                    type="number"
                                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                            ...
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Distance Goal (KM)</label>
                                <input
                                    type="number"
                                    step="1"
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Rate Per KM (₹)</label>
                                <input
                                    type="number"
                                    step="0.5"
                                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                            ...
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Visit Geofence Radius (Meters)</label>
                                <input
                                    type="number"
                                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:border-primary-500 outline-none text-slate-900 dark:text-white"
                ...
                <div className="bg-white dark:bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 p-8 rounded-[2rem] space-y-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Timezone Offset (Minutes)</label>
                            <input
                                type="number"
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-primary-500 text-slate-800 dark:text-slate-200"
                ...
                <div className="bg-white dark:bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 p-8 rounded-[2rem] space-y-6 md:col-span-2">
                    <div className="flex items-center gap-3 mb-2">
                        <div className="p-2.5 rounded-xl bg-emerald-600/10 border border-emerald-500/20 text-emerald-500">
                            <MapPin size={20} />
                        </div>
                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">Office Location & Security</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-4">
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Office Geofence Center (GPS)</label>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <p className="text-[10px] text-slate-500 dark:text-slate-400 mb-1 font-bold">Latitude</p>
                                    <input
                                        type="number"
                                        step="0.000001"
                                ...
                                <div>
                                    <p className="text-[10px] text-slate-500 dark:text-slate-400 mb-1 font-bold">Longitude</p>
                                    <input
                                        type="number"
                                        step="0.000001"
                            ...
                            <button
                                ...
                                className="w-full py-2 bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300 text-[10px] font-bold rounded-lg border border-slate-300 dark:border-slate-700 transition-colors uppercase tracking-widest"
                            >
                        ...
                        <div className="space-y-4">
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Restricted Office WiFi (SSID)</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Restricted Office WiFi (BSSID)</label>
                                <input
                                    type="text"
                            ...
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Geofence Radius (Meters)</label>
                                <input
                                    type="number"
                                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 text-sm focus:border-primary-500 outline-none text-slate-900 dark:text-white"
                ...
                <div className="bg-white dark:bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 p-8 rounded-[2rem] space-y-6 md:col-span-2">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">Custom Branding</h2>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Primary Ecosystem Color</label>
                            <div className="flex items-center gap-4">
                                ...
                                />
                                <div>
                                    <p className="text-sm text-slate-800 dark:text-slate-200 font-mono uppercase">{settings.primary_color || '#6366f1'}</p>
                        ...
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Organization Logo</label>
                            <label className="p-4 rounded-xl border-2 border-dashed border-slate-200 dark:border-slate-800 hover:border-slate-300 dark:border-slate-700 transition-colors flex flex-col items-center justify-center cursor-pointer bg-slate-50 dark:bg-slate-100 dark:bg-slate-950/50 min-h-[100px] relative overflow-hidden">
                                {settings.logo_url ? (
                                    <img
                                    ...
                                    <p className="text-[10px] text-slate-500 dark:text-slate-400 font-bold uppercase tracking-widest">Click to Upload Logo</p>
                                )}
                                ...
                                />
                                {saving && (
                                    <div className="absolute inset-0 bg-slate-50 dark:bg-slate-950/60 flex items-center justify-center">
                ...
                <div className="bg-white dark:bg-white dark:bg-slate-900/40 backdrop-blur-md border border-slate-200 dark:border-slate-800 p-8 rounded-[2rem] space-y-6 md:col-span-2">
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <h2 className="text-lg font-bold text-slate-900 dark:text-white">Work From Home (WFH) Policy</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div className="space-y-6">
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest block">Screenshot Interval</label>
                                ...
                                <input
                                    ...
                                    max="60"
                                    step="5"
                                    className="w-full h-1 bg-slate-50 dark:bg-slate-950 rounded-lg appearance-none cursor-pointer accent-indigo-500"
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest block">Face Check Interval</label>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest block">Max Idle Timeout</label>
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-2">
                                    <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest block">Productivity Threshold</label>
                        ...
                        <div className="space-y-4">
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Working Hours Start</label>
                                    <input
                                        type="time"
                                        className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 text-slate-800 dark:text-slate-200"
                                        value={wfhPolicy.working_hours_start}
                                        onChange={(e) => setWfhPolicy({ ...wfhPolicy, working_hours_start: e.target.value })}
                                    />
                                </div>
                                <div>
                                    <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Working Hours End</label>
                                    <input
                                        type="time"
                                        className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 text-slate-800 dark:text-slate-200"
                            ...
                            <div>
                                <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Screenshot Retention (Days)</label>
                                <input
                                    type="number"
                                    className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 text-slate-800 dark:text-slate-200"
                            ...
                            <div className="flex items-center gap-3 py-2">
                                <input
                                    ...
                                    className="w-4 h-4 rounded border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 text-indigo-500 focus:ring-indigo-500 cursor-pointer"
                                    checked={wfhPolicy.require_face_verification}
                                    onChange={(e) => setWfhPolicy({ ...wfhPolicy, require_face_verification: e.target.checked })}
                                />
                                <label htmlFor="require_face_verification" className="text-xs font-bold text-slate-600 dark:text-slate-300 cursor-pointer">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-4 border-t border-slate-200 dark:border-slate-200 dark:border-slate-800/50">
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Productive Applications List</label>
                            <textarea
                                rows={3}
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-indigo-500 text-slate-800 dark:text-slate-200 font-mono text-xs resize-none"
                        ...
                        <div>
                            <label className="text-[10px] font-black text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-2 block">Unproductive Applications List</label>
                            <textarea
                                rows={3}
                                className="w-full bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl px-4 py-3 outline-none focus:border-rose-500 text-slate-800 dark:text-slate-200 font-mono text-xs resize-none"
