...
const AlertCard = ({ alert, onResolve, onDismiss }) => {
    ...
    return (
        <div className="relative bg-white rounded-2xl border border-slate-200 overflow-hidden hover:border-slate-300 transition-all group">
            {/* Left severity bar */}
            ...
            <div className="p-4 pl-5">
                ...
                <div className="flex items-start justify-between gap-3 mb-3">
                    <div className="flex items-center gap-2 flex-1 min-w-0">
                        ...
                        <p className="text-slate-900 font-semibold text-sm leading-snug line-clamp-2">
                            {alert.detail}
                        </p>
                    </div>
                ...
                {alert.status === 'pending' ? (
                    <div className="flex items-center gap-2">
                        <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-slate-100 text-slate-500 text-[11px] font-bold transition-all"
                        >
    ...
    return (
        <div className="flex flex-col h-full gap-6">
                ...
                <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center gap-3">
                        <select
                            ...
                            className="bg-slate-50 border border-slate-200 text-slate-900 rounded-xl px-4 py-2 text-sm"
                        >
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <StatMini label="Categories" value={CATEGORIES.length} color="#004B87" icon={BarChart2} />
            </div>
                    ...
                    {CATEGORIES.map(cat => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className="text-slate-500 text-[10px] mt-0.5 leading-snug">{cat.description}</p>
                            </button>
                        );
                    })}
                </div>
                ...
                <div className="flex-1 overflow-y-auto space-y-3 pr-1">
                    ...
                    {activeCat && (
                        <div className={`bg-gradient-to-r ${activeCat.gradient} rounded-2xl border ${activeCat.border} p-4 flex items-center gap-3`}>
                            ...
                            <div>
                                <p className="text-slate-900 font-bold">{activeCat.label}</p>
                                <p className="text-slate-500 text-xs">{activeCat.description}</p>
                            </div>
                            <span
                    ...
                    {loading ? (
                        ...
                        <div className="flex flex-col items-center justify-center h-64 gap-4">
                            ...
                            <p className="text-slate-900 font-bold">No Alerts</p>
